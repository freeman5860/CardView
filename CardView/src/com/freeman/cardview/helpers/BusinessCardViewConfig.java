...
public class BusinessCardViewConfig {
     ...
     * Private constructor
     */
    private BusinessCardViewConfig(Context context) {
     ...
     */
    public static BusinessCardViewConfig reinitialize(Context context) {
        if (sInstance == null) {
            sInstance = new BusinessCardViewConfig(context);
        }
     ...
     */
    public static BusinessCardViewConfig getInstance() {
        return sInstance;
    }
