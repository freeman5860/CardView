...
public class BusinessCardChildViewTransform {
	...
	public BusinessCardChildViewTransform(BusinessCardChildViewTransform o) {
	...
	public void applyToTaskView(View v, int duration, Interpolator interp,
			boolean allowLayers, boolean allowShadows,
		...
		if(DVUtils.isAboveSDKVersion(11)){
			...
			applyToTaskViewCompat(v);
		}
	}

	public void applyToTaskViewCompat(View v) {
		
		if (hasTranslationYChangedFrom(ViewHelper.getTranslationY(v))) {
	...
	public static void resetCompat(View v) {
		ViewHelper.setTranslationX(v, 0f);
	...
	public String toString() {
		return "TaskViewTransform delay: " + startDelay + " y: " + translationY
				+ " z: " + translationZ + " scale: " + scale + " alpha: "
				+ alpha + " visible: " + visible + " rect: " + rect + " p: "
				+ p;
	}
}
