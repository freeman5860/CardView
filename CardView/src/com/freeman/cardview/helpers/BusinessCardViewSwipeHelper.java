 ...
 */
public class BusinessCardViewSwipeHelper {
    ...
    public BusinessCardViewSwipeHelper(int swipeDirection, Callback callback, float densityScale,
    ...
    private void snapChild(final View view, float velocity) {
        ...
        anim.setDuration(duration);
        anim.setInterpolator(BusinessCardViewConfig.getInstance().linearOutSlowInInterpolator);
        anim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                if (FADE_OUT_DURING_SWIPE && canAnimViewBeDismissed) {
