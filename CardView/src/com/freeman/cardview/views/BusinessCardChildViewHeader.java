 ...
 */
/* The task bar view */
public class BusinessCardChildViewHeader extends FrameLayout {
    ...
    public BusinessCardChildViewHeader(Context context) {
        this(context, null);
    }

    public BusinessCardChildViewHeader(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BusinessCardChildViewHeader(Context context, AttributeSet attrs, int defStyleAttr) {
