 ...
 */
public class BusinessCardChildViewThumbnail extends View {
    ...
    public BusinessCardChildViewThumbnail(Context context) {
        this(context, null);
    }

    public BusinessCardChildViewThumbnail(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BusinessCardChildViewThumbnail(Context context, AttributeSet attrs, int defStyleAttr) {
